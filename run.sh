...
python main.py --data ../datasets/ptb --num_layers 2 --init_lr 1.0 --epochs 100 --eval_batch_size 10 --test_batch_size 10 --bptt 35 --dropout 0.5 --seed 1111 --log_interval 10 --clip 0.25 --use_gpu true --emb_size 650 --num_hid 650 --num_workers 1 --batch_size 128 --compressor terngrad --memory none --exp_name terngrad_100epochs_lr1 --project_name others_bs128_nhid650_drop0.5_compress_decay0
python main.py --data ../datasets/ptb --num_layers 2 --init_lr 10.0 --epochs 100 --eval_batch_size 10 --test_batch_size 10 --bptt 35 --dropout 0.5 --seed 1111 --log_interval 10 --clip 0.25 --use_gpu true --emb_size 650 --num_hid 650 --num_workers 1 --batch_size 128 --compressor terngrad --memory none --exp_name terngrad_100epochs_lr10 --project_name others_bs128_nhid650_drop0.5_compress_decay0
python main.py --data ../datasets/ptb --num_layers 2 --init_lr 30.0 --epochs 100 --eval_batch_size 10 --test_batch_size 10 --bptt 35 --dropout 0.5 --seed 1111 --log_interval 10 --clip 0.25 --use_gpu true --emb_size 650 --num_hid 650 --num_workers 1 --batch_size 128 --compressor terngrad --memory none --exp_name terngrad_100epochs_lr30 --project_name others_bs128_nhid650_drop0.5_compress_decay0
...
python main.py --data ../datasets/ptb --num_layers 2 --init_lr 5.0 --epochs 50 --eval_batch_size 10 --test_batch_size 10 --bptt 35 --dropout 0.5 --seed 1111 --log_interval 10 --clip 0.25 --use_gpu true --emb_size 650 --num_hid 650 --num_workers 1 --batch_size 128 --compressor signsgd --memory none --exp_name signSGD --project_name others_bs128_nhid650_drop0.5_compress_decay0
python main.py --data ../datasets/ptb --num_layers 2 --init_lr 5.0 --epochs 50 --eval_batch_size 10 --test_batch_size 10 --bptt 35 --dropout 0.5 --seed 1111 --log_interval 10 --clip 0.25 --use_gpu true --emb_size 650 --num_hid 650 --num_workers 1 --batch_size 128 --compressor signsgd --memory residual --exp_name signSGD_ResMem --project_name others_bs128_nhid650_drop0.5_compress_decay0
